...
import {CompanyContactsTable} from "@/pages";

export const EditPage = () => {
    const { saveButtonProps, formProps, formLoading, queryResult} =
        useForm({
            redirect: false,
            meta: {
                ...
                <Col xs={24} xl={12}>
                    ...
                    >
                        <Form {...formProps} layout='vertical'>
                            ...
                            <Form.Item label="Industry"> label"
                            ...
                            <Form.Item label="Website" name="websie">
